...
usage() {
    ...
    printf '  wordlist Path to DNS wordlist (default: /usr/share/wordlists/seclists/Discovery/DNS/n0kovo_subdomains.txt)\n' >&2
    exit 1
}
...
main() {
    ...
    local WORDLIST="${2:-/usr/share/wordlists/seclists/Discovery/DNS/n0kovo_subdomains.txt}"
